...
class Simpson3_8(calculoAreaClass.CalculoIntegral):
    ...
    def validaQuantidadeX(self):
        if (self.qtdPares - 1) % 3 != 0 or self.qtdPares < 4:
            raise Exception('A quantidade de intervalos precisa ser múltiplo de 3')
        return True
